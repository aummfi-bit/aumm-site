...
| **Rules > Bootstrap** | Pool Bootstrapping, Incendiary Boost, Bubble Voting, Sandbox, Gauge Approval |
| **Rules > Transitions** | Launch Procedures months 0–13+, CCB Transition, PMAR Initialisation |
| **Rules > Constitution** | Governance, CCB, PMAR, Anti-Gaming Criteria, Immutable Parameters |
...
See also: [PMAR Specification](PMAR.md) for the full Pioneer Multiplier Adjustment Rule.
