...
This dual-anchor / universal-connector design is Aureum's inheritance of the original Sagix construction — see [Sagix — Miliarium Aureum](https://www.sagix.io/sagix-miliarium-aureum/) for the small-world graph that uses **svZCHF** and **ixEDEL** as the shortcut hubs connecting every pool, and the [Sagix four-layer framework](https://www.sagix.io/our-layer-framework/) for the liquidity-risk decomposition (venue / routing / anchor / reserve) those two rails operationalise. Aureum keeps the backbone and refines two slots — **ixHelvetia (01)** as the Frankencoin MMA and **ixLibertas (06)** as the USD hub — where pure CHF or pure USD flows are deliberately kept off the ixEDEL basket bridge.
