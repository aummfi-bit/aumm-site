...
- **After Year 1:** pure CCB weighting — each pool is scored by its smoothed TVL, PMAR multiplier, and Incendiary multiplier, then normalized across all eligible pools. See `constitution.md` and `formulas.md`.
