...
- Automatic CCB allocation after the transition (EMA TVL, MAMAR, and Incendiary terms per `constitution.md`).
...
- **After Year 1:** emissions follow only the CCB — each pool scored by smoothed TVL, MAMAR multiplier, and Incendiary multiplier, normalized across eligible pools. No vote. See `constitution.md` and `formulas.md`.
