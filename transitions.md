...
- Allocation is **pure** CCB: each pool scored by smoothed TVL, MAMAR multiplier, and Incendiary multiplier, normalized across eligible pools. See `constitution.md` and `formulas.md`.
