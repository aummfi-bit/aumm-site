...
| [Constitution](10_constitution.md), [Tokenomics](04_tokenomics.md), [Protocol formulas](11_formulas.md), … | Core protocol specs |
...
- **Miliarium ▾** in the nav opens **Registry** ([Miliarium Aureum registry](05_miliarium_aureum.md)), **Manifest**, **Sectors**, and in-app rendering of pool profile files so `.md` links do not open as raw files.
